    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <div className="inline-block px-4 py-1.5 mb-6 rounded-full border border-primary/30 bg-primary/10 text-primary text-sm font-medium">
          Mechanical Engineer · Designer · CNC Programmer
        </div>

        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-6" style={{ fontFamily: 'Space Grotesk' }}>
          Designing Efficient{' '}
          <span className="text-gradient">Mechanical Systems</span>
        </h1>

        <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          Passionate about gear manufacturing, CNC programming, and precision mechanical design.
          Turning complex engineering challenges into elegant, manufacturable solutions.
        </p>
